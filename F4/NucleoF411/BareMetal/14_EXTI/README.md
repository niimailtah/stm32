...
По нажатию кнопки происходит внешнее прерывание.
В обработчике прерывания пишем в UART и зажигаем/гасим светодиод.
...
monitor reset init
monitor flash write_image erase 14_EXTI.elf
monitor reset init
monitor resume
```
...
```
c:\tools\ST\STM32CubeProgrammer\bin\STM32_Programmer_CLI.exe --connect port=swd --download 14_EXTI.elf -hardRst
```
