...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct I2S2ext_CR1_DFF_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<I2S2ext_CR1_DFF_Values, BaseType, 0U> ;
  using Value1 = FieldValue<I2S2ext_CR1_DFF_Values, BaseType, 1U> ;
} ;
