...
{
  using Value0 = FieldValue<USART2_SR_NF_Values, BaseType, 0U> ;
  using Value1 = FieldValue<USART2_SR_NF_Values, BaseType, 1U> ;
} ;
...
{
  using Value0 = FieldValue<USART2_CR1_OVER8_Values, BaseType, 0U> ;
  using Value1 = FieldValue<USART2_CR1_OVER8_Values, BaseType, 1U> ;
} ;
