...
if ($loc -eq "Home") {
	...
	Set-Location -Path "d:\Docs\repos\stm32\F4\NUCLEO-F411RE\BareMetal\09_GTIM\"
}
elseif ($loc -eq "Work") {
	#Windows build tools
	...
	Set-Location -Path "c:\Users\chuwi\STM32CubeIDE\F4\NUCLEO-F411RE\BareMetal\09_GTIM\"
}
else {
	Write-Output "Fail"
}
