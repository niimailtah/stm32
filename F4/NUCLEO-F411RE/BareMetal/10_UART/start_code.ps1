...
if ($loc -eq "Home") {
	...
	Set-Location -Path "d:\Docs\repos\stm32\F4\NUCLEO-F411RE\BareMetal\10_UART\"
}
elseif ($loc -eq "Work") {
	#Windows build tools
	...
	Set-Location -Path "c:\Users\chuwi\STM32CubeIDE\F4\NUCLEO-F411RE\BareMetal\10_UART\"
}
else {
	Write-Output "Fail"
}
