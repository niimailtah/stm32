...
- Build manually
```
arm-none-eabi-gcc -mcpu=cortex-m4 --specs=nosys.specs --specs=nano.specs -mthumb -DDEBUG -DSTM32F411xE -Iinc -I..\CMSIS\Device\ST\STM32F4xx\Include -I..\CMSIS\Include -T"STM32F411RETX_FLASH.ld" Startup/startup_stm32f411retx.s Src/main.c Src/gpio.c Src/syscalls.c Src/sysmem.c Src/system_stm32f4xx.c -o firmware.elf
