...
{
  using Disable = FieldValue<TIM2_SR_UIF_Values, BaseType, 0U> ;
  using Enable = FieldValue<TIM2_SR_UIF_Values, BaseType, 1U> ;
} ;
...
{
  using Value0 = FieldValue<TIM2_OR_ITR1_RMP_Values, BaseType, 0U> ;
  using Value1 = FieldValue<TIM2_OR_ITR1_RMP_Values, BaseType, 1U> ;
  using Value2 = FieldValue<TIM2_OR_ITR1_RMP_Values, BaseType, 2U> ;
  using Value3 = FieldValue<TIM2_OR_ITR1_RMP_Values, BaseType, 3U> ;
} ;
