...
struct RCC
{
  ...
  struct CFGR : public RegisterBase<0x40023808, 32, ReadWriteMode>
  {
    ...
    using SWS1 = RCC_CFGR_SWS1_Values<RCC::CFGR, 3, 1, ReadMode, RCCCFGRBase> ;
    using SWS0 = RCC_CFGR_SWS0_Values<RCC::CFGR, 2, 1, ReadMode, RCCCFGRBase> ;
    using SW1 = RCC_CFGR_SW1_Values<RCC::CFGR, 1, 1, ReadWriteMode, RCCCFGRBase> ;
    using SW0 = RCC_CFGR_SW0_Values<RCC::CFGR, 0, 1, ReadWriteMode, RCCCFGRBase> ;
    using FieldValues = RCC_CFGR_SW0_Values<RCC::CFGR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct BDCR : public RegisterBase<0x40023870, 32, ReadWriteMode>
  {
    ...
    using RTCSEL1 = RCC_BDCR_RTCSEL1_Values<RCC::BDCR, 9, 1, ReadWriteMode, RCCBDCRBase> ;
    using RTCSEL0 = RCC_BDCR_RTCSEL0_Values<RCC::BDCR, 8, 1, ReadWriteMode, RCCBDCRBase> ;
