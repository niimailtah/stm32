...
if ($loc -eq "Home") {
	...
	Set-Location -Path "d:\Docs\repos\stm32\H7\WeAct-H743VI\BareMetal\07_GpioOutput\"
}
elseif ($loc -eq "Work") {
	#Windows build tools
	...
	Set-Location -Path "c:\Users\chuwi\STM32CubeIDE\F4\BlackF407VET6\BareMetal\07_GpioOutput\"
}
else {
	Write-Output "Fail"
}
