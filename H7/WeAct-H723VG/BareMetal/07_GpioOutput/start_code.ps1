...
if ($loc -eq "Home") {
	...
	Set-Location -Path "d:\Docs\repos\stm32\H7\WeAct-H723VG\BareMetal\07_GpioOutput\"
}
elseif ($loc -eq "Work") {
	#Windows build tools
	...
	Set-Location -Path "c:\Users\chuwi\STM32CubeIDE\H7\WeAct-H723VG\BareMetal\07_GpioOutput\"
}
else {
	Write-Output "Fail"
}
