...
CPP_FLAGS += $(CPPSTANDARD) $(INCDIR)  $(OPT) $(COMPILE_OPT)
...
OBJECTS += $(addprefix $(BUILD_DIR)/,$(notdir $(SOURCES_TOTAL_CPP:.cpp=.o)))
vpath %.cpp $(sort $(dir $(SOURCES_TOTAL_CPP)))
...
$(BUILD_DIR)/%.o: %.cpp Makefile | $(BUILD_DIR)
	$(eval CURRENT_CNT=$(shell echo $$(($(CURRENT_CNT)+1))))
	@echo Compiling $(CURRENT_CNT)/$(TOTAL_FILES) $@
# 	@$(CPP) -c -MD $(CFLAGS) -Wa,-a,-ad,-alms=$(BUILD_DIR)/$(notdir $(<:.cpp=.lst)) $< -o $@
	@$(CPP) -c $(CPPFLAGS) $< -o $@
