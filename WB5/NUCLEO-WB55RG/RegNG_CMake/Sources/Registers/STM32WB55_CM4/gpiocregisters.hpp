...
struct GPIOC
{
  ...
  struct MODER : public RegisterBase<0x48000800, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using MODERPack  = Register<0x48000800, 32, ReadWriteMode, GPIOCMODERBase, T...> ;

  struct GPIOCOTYPERBase {} ;

  struct OTYPER : public RegisterBase<0x48000804, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OTYPERPack  = Register<0x48000804, 32, ReadWriteMode, GPIOCOTYPERBase, T...> ;

  struct GPIOCOSPEEDRBase {} ;

  struct OSPEEDR : public RegisterBase<0x48000808, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OSPEEDRPack  = Register<0x48000808, 32, ReadWriteMode, GPIOCOSPEEDRBase, T...> ;

  struct GPIOCPUPDRBase {} ;

  struct PUPDR : public RegisterBase<0x4800080C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PUPDRPack  = Register<0x4800080C, 32, ReadWriteMode, GPIOCPUPDRBase, T...> ;

  struct GPIOCIDRBase {} ;

  struct IDR : public RegisterBase<0x48000810, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using IDRPack  = Register<0x48000810, 32, ReadMode, GPIOCIDRBase, T...> ;

  struct GPIOCODRBase {} ;

  struct ODR : public RegisterBase<0x48000814, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ODRPack  = Register<0x48000814, 32, ReadWriteMode, GPIOCODRBase, T...> ;

  struct GPIOCBSRRBase {} ;

  struct BSRR : public RegisterBase<0x48000818, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using BSRRPack  = Register<0x48000818, 32, WriteMode, GPIOCBSRRBase, T...> ;

  struct GPIOCLCKRBase {} ;

  struct LCKR : public RegisterBase<0x4800081C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LCKRPack  = Register<0x4800081C, 32, ReadWriteMode, GPIOCLCKRBase, T...> ;

  struct GPIOCAFRLBase {} ;

  struct AFRL : public RegisterBase<0x48000820, 32, ReadWriteMode>
  {
    ...
    using FieldValues = GPIOC_AFRL_AFSEL0_Values<GPIOC::AFRL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AFRLPack  = Register<0x48000820, 32, ReadWriteMode, GPIOCAFRLBase, T...> ;

  struct GPIOCAFRHBase {} ;

  struct AFRH : public RegisterBase<0x48000824, 32, ReadWriteMode>
  {
    ...
    using FieldValues = GPIOC_AFRH_AFSEL8_Values<GPIOC::AFRH, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AFRHPack  = Register<0x48000824, 32, ReadWriteMode, GPIOCAFRHBase, T...> ;

  struct GPIOCBRRBase {} ;

  struct BRR : public RegisterBase<0x48000828, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using BRRPack  = Register<0x48000828, 32, WriteMode, GPIOCBRRBase, T...> ;
