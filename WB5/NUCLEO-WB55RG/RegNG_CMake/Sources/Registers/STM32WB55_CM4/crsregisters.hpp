...
struct CRS
{
  ...
  struct CR : public RegisterBase<0x40006000, 32, ReadWriteMode>
  {
    ...
    using FieldValues = CRS_CR_TRIM_Values<CRS::CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CRPack  = Register<0x40006000, 32, ReadWriteMode, CRSCRBase, T...> ;

  struct CRSCFGRBase {} ;

  struct CFGR : public RegisterBase<0x40006004, 32, ReadWriteMode>
  {
    ...
    using FieldValues = CRS_CFGR_SYNCPOL_Values<CRS::CFGR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CFGRPack  = Register<0x40006004, 32, ReadWriteMode, CRSCFGRBase, T...> ;

  struct CRSISRBase {} ;

  struct ISR : public RegisterBase<0x40006008, 32, ReadMode>
  {
    ...
    using FieldValues = CRS_ISR_FECAP_Values<CRS::ISR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ISRPack  = Register<0x40006008, 32, ReadMode, CRSISRBase, T...> ;

  struct CRSICRBase {} ;

  struct ICR : public RegisterBase<0x4000600C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = CRS_ICR_ESYNCC_Values<CRS::ICR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ICRPack  = Register<0x4000600C, 32, ReadWriteMode, CRSICRBase, T...> ;
