...
struct TIM1
{
  ...
  struct CR1 : public RegisterBase<0x40012C00, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR1Pack  = Register<0x40012C00, 32, ReadWriteMode, TIM1CR1Base, T...> ;

  struct TIM1CR2Base {} ;

  struct CR2 : public RegisterBase<0x40012C04, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR2Pack  = Register<0x40012C04, 32, ReadWriteMode, TIM1CR2Base, T...> ;

  struct TIM1SMCRBase {} ;

  struct SMCR : public RegisterBase<0x40012C08, 32, ReadWriteMode>
  {
    using SMS = TIM1_SMCR_SMS_Values<TIM1::SMCR, 0, 3, ReadWriteMode, TIM1SMCRBase> ;
    using OCCS = TIM1_SMCR_OCCS_Values<TIM1::SMCR, 3, 1, ReadWriteMode, TIM1SMCRBase> ;
    ...
    using FieldValues = TIM1_SMCR_SMS_3_Values<TIM1::SMCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SMCRPack  = Register<0x40012C08, 32, ReadWriteMode, TIM1SMCRBase, T...> ;

  struct TIM1DIERBase {} ;

  struct DIER : public RegisterBase<0x40012C0C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM1_DIER_TDE_Values<TIM1::DIER, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DIERPack  = Register<0x40012C0C, 32, ReadWriteMode, TIM1DIERBase, T...> ;

  struct TIM1SRBase {} ;

  struct SR : public RegisterBase<0x40012C10, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM1_SR_CC6IF_Values<TIM1::SR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SRPack  = Register<0x40012C10, 32, ReadWriteMode, TIM1SRBase, T...> ;

  struct TIM1EGRBase {} ;

  struct EGR : public RegisterBase<0x40012C14, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using EGRPack  = Register<0x40012C14, 32, WriteMode, TIM1EGRBase, T...> ;

  struct TIM1CCMR1_InputBase {} ;

  struct CCMR1_Input : public RegisterBase<0x40012C18, 32, ReadWriteMode>
  {
    using CC1S = TIM1_CCMR1_Input_CC1S_Values<TIM1::CCMR1_Input, 0, 2, ReadWriteMode, TIM1CCMR1_InputBase> ;
    using IC1PSC = TIM1_CCMR1_Input_IC1PSC_Values<TIM1::CCMR1_Input, 2, 2, ReadWriteMode, TIM1CCMR1_InputBase> ;
    using C1F = TIM1_CCMR1_Input_C1F_Values<TIM1::CCMR1_Input, 4, 4, ReadWriteMode, TIM1CCMR1_InputBase> ;
    using CC2S = TIM1_CCMR1_Input_CC2S_Values<TIM1::CCMR1_Input, 8, 2, ReadWriteMode, TIM1CCMR1_InputBase> ;
    using IC2PSC = TIM1_CCMR1_Input_IC2PSC_Values<TIM1::CCMR1_Input, 10, 2, ReadWriteMode, TIM1CCMR1_InputBase> ;
    using IC2F = TIM1_CCMR1_Input_IC2F_Values<TIM1::CCMR1_Input, 12, 4, ReadWriteMode, TIM1CCMR1_InputBase> ;
    using FieldValues = TIM1_CCMR1_Input_IC2F_Values<TIM1::CCMR1_Input, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CCMR1_InputPack  = Register<0x40012C18, 32, ReadWriteMode, TIM1CCMR1_InputBase, T...> ;

  struct TIM1CCMR1_OutputBase {} ;

  struct CCMR1_Output : public RegisterBase<0x40012C18, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCMR1_OutputPack  = Register<0x40012C18, 32, ReadWriteMode, TIM1CCMR1_OutputBase, T...> ;

  struct TIM1CCMR2_OutputBase {} ;

  struct CCMR2_Output : public RegisterBase<0x40012C1C, 32, ReadWriteMode>
  {
    ...
    using OC4M_3 = TIM1_CCMR2_Output_OC4M_3_Values<TIM1::CCMR2_Output, 24, 1, ReadWriteMode, TIM1CCMR2_OutputBase> ;
    using FieldValues = TIM1_CCMR2_Output_OC4M_3_Values<TIM1::CCMR2_Output, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CCMR2_OutputPack  = Register<0x40012C1C, 32, ReadWriteMode, TIM1CCMR2_OutputBase, T...> ;

  struct TIM1CCMR2_InputBase {} ;

  struct CCMR2_Input : public RegisterBase<0x40012C1C, 32, ReadWriteMode>
  {
    using CC3S = TIM1_CCMR2_Input_CC3S_Values<TIM1::CCMR2_Input, 0, 2, ReadWriteMode, TIM1CCMR2_InputBase> ;
    using C3PSC = TIM1_CCMR2_Input_C3PSC_Values<TIM1::CCMR2_Input, 2, 2, ReadWriteMode, TIM1CCMR2_InputBase> ;
    ...
    using FieldValues = TIM1_CCMR2_Input_IC4F_Values<TIM1::CCMR2_Input, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CCMR2_InputPack  = Register<0x40012C1C, 32, ReadWriteMode, TIM1CCMR2_InputBase, T...> ;

  struct TIM1CCERBase {} ;

  struct CCER : public RegisterBase<0x40012C20, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCERPack  = Register<0x40012C20, 32, ReadWriteMode, TIM1CCERBase, T...> ;

  struct TIM1CNTBase {} ;

  struct CNT : public RegisterBase<0x40012C24, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CNTPack  = Register<0x40012C24, 32, ReadWriteMode, TIM1CNTBase, T...> ;

  struct TIM1PSCBase {} ;

  struct PSC : public RegisterBase<0x40012C28, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PSCPack  = Register<0x40012C28, 32, ReadWriteMode, TIM1PSCBase, T...> ;

  struct TIM1ARRBase {} ;

  struct ARR : public RegisterBase<0x40012C2C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ARRPack  = Register<0x40012C2C, 32, ReadWriteMode, TIM1ARRBase, T...> ;

  struct TIM1RCRBase {} ;

  struct RCR : public RegisterBase<0x40012C30, 32, ReadWriteMode>
  {
    using REP = TIM1_RCR_REP_Values<TIM1::RCR, 0, 16, ReadWriteMode, TIM1RCRBase> ;
    using FieldValues = TIM1_RCR_REP_Values<TIM1::RCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RCRPack  = Register<0x40012C30, 32, ReadWriteMode, TIM1RCRBase, T...> ;

  struct TIM1CCR1Base {} ;

  struct CCR1 : public RegisterBase<0x40012C34, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCR1Pack  = Register<0x40012C34, 32, ReadWriteMode, TIM1CCR1Base, T...> ;

  struct TIM1CCR2Base {} ;

  struct CCR2 : public RegisterBase<0x40012C38, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCR2Pack  = Register<0x40012C38, 32, ReadWriteMode, TIM1CCR2Base, T...> ;

  struct TIM1CCR3Base {} ;

  struct CCR3 : public RegisterBase<0x40012C3C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCR3Pack  = Register<0x40012C3C, 32, ReadWriteMode, TIM1CCR3Base, T...> ;

  struct TIM1CCR4Base {} ;

  struct CCR4 : public RegisterBase<0x40012C40, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCR4Pack  = Register<0x40012C40, 32, ReadWriteMode, TIM1CCR4Base, T...> ;

  struct TIM1BDTRBase {} ;

  struct BDTR : public RegisterBase<0x40012C44, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using BDTRPack  = Register<0x40012C44, 32, ReadWriteMode, TIM1BDTRBase, T...> ;

  struct TIM1DCRBase {} ;

  struct DCR : public RegisterBase<0x40012C48, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DCRPack  = Register<0x40012C48, 32, ReadWriteMode, TIM1DCRBase, T...> ;

  struct TIM1DMARBase {} ;

  struct DMAR : public RegisterBase<0x40012C4C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DMARPack  = Register<0x40012C4C, 32, ReadWriteMode, TIM1DMARBase, T...> ;

  struct TIM1ORBase {} ;

  struct OR : public RegisterBase<0x40012C50, 32, ReadWriteMode>
  {
    using TIM1_ETR_ADC1_RMP = TIM1_OR_TIM1_ETR_ADC1_RMP_Values<TIM1::OR, 0, 2, ReadWriteMode, TIM1ORBase> ;
    using TI1_RMP = TIM1_OR_TI1_RMP_Values<TIM1::OR, 4, 1, ReadWriteMode, TIM1ORBase> ;
    using FieldValues = TIM1_OR_TI1_RMP_Values<TIM1::OR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ORPack  = Register<0x40012C50, 32, ReadWriteMode, TIM1ORBase, T...> ;

  struct TIM1CCMR3_OutputBase {} ;

  struct CCMR3_Output : public RegisterBase<0x40012C54, 32, ReadWriteMode>
  {
    using OC6M_bit3 = TIM1_CCMR3_Output_OC6M_bit3_Values<TIM1::CCMR3_Output, 24, 1, ReadWriteMode, TIM1CCMR3_OutputBase> ;
    using OC5M_bit3 = TIM1_CCMR3_Output_OC5M_bit3_Values<TIM1::CCMR3_Output, 16, 1, ReadWriteMode, TIM1CCMR3_OutputBase> ;
    ...
    using FieldValues = TIM1_CCMR3_Output_OC5FE_Values<TIM1::CCMR3_Output, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CCMR3_OutputPack  = Register<0x40012C54, 32, ReadWriteMode, TIM1CCMR3_OutputBase, T...> ;

  struct TIM1CCR5Base {} ;

  struct CCR5 : public RegisterBase<0x40012C58, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCR5Pack  = Register<0x40012C58, 32, ReadWriteMode, TIM1CCR5Base, T...> ;

  struct TIM1CCR6Base {} ;

  struct CCR6 : public RegisterBase<0x40012C5C, 32, ReadWriteMode>
  {
    using CCR6Field = TIM1_CCR6_CCR6_Values<TIM1::CCR6, 0, 16, ReadWriteMode, TIM1CCR6Base> ;
    using FieldValues = TIM1_CCR6_CCR6_Values<TIM1::CCR6, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CCR6Pack  = Register<0x40012C5C, 32, ReadWriteMode, TIM1CCR6Base, T...> ;

  struct TIM1AF1Base {} ;

  struct AF1 : public RegisterBase<0x40012C60, 32, ReadWriteMode>
  {
    ...
    using ETRSEL = TIM1_AF1_ETRSEL_Values<TIM1::AF1, 14, 3, ReadWriteMode, TIM1AF1Base> ;
    using FieldValues = TIM1_AF1_ETRSEL_Values<TIM1::AF1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AF1Pack  = Register<0x40012C60, 32, ReadWriteMode, TIM1AF1Base, T...> ;

  struct TIM1AF2Base {} ;

  struct AF2 : public RegisterBase<0x40012C64, 32, ReadWriteMode>
  {
    ...
    using BK2DFBK0E = TIM1_AF2_BK2DFBK0E_Values<TIM1::AF2, 8, 1, ReadWriteMode, TIM1AF2Base> ;
  ...
  template<typename... T> 
  using AF2Pack  = Register<0x40012C64, 32, ReadWriteMode, TIM1AF2Base, T...> ;
