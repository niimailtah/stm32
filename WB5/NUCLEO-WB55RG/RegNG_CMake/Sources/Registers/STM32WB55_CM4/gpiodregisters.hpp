...
struct GPIOD
{
  ...
  struct MODER : public RegisterBase<0x48000C00, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using MODERPack  = Register<0x48000C00, 32, ReadWriteMode, GPIODMODERBase, T...> ;

  struct GPIODOTYPERBase {} ;

  struct OTYPER : public RegisterBase<0x48000C04, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OTYPERPack  = Register<0x48000C04, 32, ReadWriteMode, GPIODOTYPERBase, T...> ;

  struct GPIODOSPEEDRBase {} ;

  struct OSPEEDR : public RegisterBase<0x48000C08, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OSPEEDRPack  = Register<0x48000C08, 32, ReadWriteMode, GPIODOSPEEDRBase, T...> ;

  struct GPIODPUPDRBase {} ;

  struct PUPDR : public RegisterBase<0x48000C0C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PUPDRPack  = Register<0x48000C0C, 32, ReadWriteMode, GPIODPUPDRBase, T...> ;

  struct GPIODIDRBase {} ;

  struct IDR : public RegisterBase<0x48000C10, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using IDRPack  = Register<0x48000C10, 32, ReadMode, GPIODIDRBase, T...> ;

  struct GPIODODRBase {} ;

  struct ODR : public RegisterBase<0x48000C14, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ODRPack  = Register<0x48000C14, 32, ReadWriteMode, GPIODODRBase, T...> ;

  struct GPIODBSRRBase {} ;

  struct BSRR : public RegisterBase<0x48000C18, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using BSRRPack  = Register<0x48000C18, 32, WriteMode, GPIODBSRRBase, T...> ;

  struct GPIODLCKRBase {} ;

  struct LCKR : public RegisterBase<0x48000C1C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LCKRPack  = Register<0x48000C1C, 32, ReadWriteMode, GPIODLCKRBase, T...> ;

  struct GPIODAFRLBase {} ;

  struct AFRL : public RegisterBase<0x48000C20, 32, ReadWriteMode>
  {
    ...
    using FieldValues = GPIOD_AFRL_AFSEL0_Values<GPIOD::AFRL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AFRLPack  = Register<0x48000C20, 32, ReadWriteMode, GPIODAFRLBase, T...> ;

  struct GPIODAFRHBase {} ;

  struct AFRH : public RegisterBase<0x48000C24, 32, ReadWriteMode>
  {
    ...
    using FieldValues = GPIOD_AFRH_AFSEL8_Values<GPIOD::AFRH, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AFRHPack  = Register<0x48000C24, 32, ReadWriteMode, GPIODAFRHBase, T...> ;

  struct GPIODBRRBase {} ;

  struct BRR : public RegisterBase<0x48000C28, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using BRRPack  = Register<0x48000C28, 32, WriteMode, GPIODBRRBase, T...> ;
