...
struct SAI1
{
  ...
  struct GCR : public RegisterBase<0x40015400, 32, ReadWriteMode>
  {
    using SYNCOUT = SAI1_GCR_SYNCOUT_Values<SAI1::GCR, 4, 2, ReadWriteMode, SAI1GCRBase> ;
    using SYNCIN = SAI1_GCR_SYNCIN_Values<SAI1::GCR, 0, 2, ReadWriteMode, SAI1GCRBase> ;
    using FieldValues = SAI1_GCR_SYNCIN_Values<SAI1::GCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using GCRPack  = Register<0x40015400, 32, ReadWriteMode, SAI1GCRBase, T...> ;

  struct SAI1BCR1Base {} ;

  struct BCR1 : public RegisterBase<0x40015424, 32, ReadWriteMode>
  {
    using MCKEN = SAI1_BCR1_MCKEN_Values<SAI1::BCR1, 27, 1, ReadWriteMode, SAI1BCR1Base> ;
    using OSR = SAI1_BCR1_OSR_Values<SAI1::BCR1, 26, 1, ReadWriteMode, SAI1BCR1Base> ;
    using MCJDIV = SAI1_BCR1_MCJDIV_Values<SAI1::BCR1, 20, 6, ReadWriteMode, SAI1BCR1Base> ;
  ...
  {
    using MCKEN = SAI1_ACR1_MCKEN_Values<SAI1::ACR1, 27, 1, ReadWriteMode, SAI1ACR1Base> ;
    using OSR = SAI1_ACR1_OSR_Values<SAI1::ACR1, 26, 1, ReadWriteMode, SAI1ACR1Base> ;
    using MCJDIV = SAI1_ACR1_MCJDIV_Values<SAI1::ACR1, 20, 6, ReadWriteMode, SAI1ACR1Base> ;
    ...
    using SAIBEN = SAI1_ACR1_SAIBEN_Values<SAI1::ACR1, 16, 1, ReadWriteMode, SAI1ACR1Base> ;
  ...
  struct ASR : public RegisterBase<0x40015418, 32, ReadMode>
  {
    using FLVL = SAI1_ASR_FLVL_Values<SAI1::ASR, 16, 3, ReadMode, SAI1ASRBase> ;
    using LFSDET = SAI1_ASR_LFSDET_Values<SAI1::ASR, 6, 1, ReadMode, SAI1ASRBase> ;
    using AFSDET = SAI1_ASR_AFSDET_Values<SAI1::ASR, 5, 1, ReadMode, SAI1ASRBase> ;
    using CNRDY = SAI1_ASR_CNRDY_Values<SAI1::ASR, 4, 1, ReadMode, SAI1ASRBase> ;
    using FREQ = SAI1_ASR_FREQ_Values<SAI1::ASR, 3, 1, ReadMode, SAI1ASRBase> ;
    using WCKCFG = SAI1_ASR_WCKCFG_Values<SAI1::ASR, 2, 1, ReadMode, SAI1ASRBase> ;
    using MUTEDET = SAI1_ASR_MUTEDET_Values<SAI1::ASR, 1, 1, ReadMode, SAI1ASRBase> ;
    using OVRUDR = SAI1_ASR_OVRUDR_Values<SAI1::ASR, 0, 1, ReadMode, SAI1ASRBase> ;
    using FieldValues = SAI1_ASR_OVRUDR_Values<SAI1::ASR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ASRPack  = Register<0x40015418, 32, ReadMode, SAI1ASRBase, T...> ;

  struct SAI1ACLRFRBase {} ;

  struct ACLRFR : public RegisterBase<0x4001541C, 32, WriteMode>
  {
    using LFSDET = SAI1_ACLRFR_LFSDET_Values<SAI1::ACLRFR, 6, 1, WriteMode, SAI1ACLRFRBase> ;
    using CAFSDET = SAI1_ACLRFR_CAFSDET_Values<SAI1::ACLRFR, 5, 1, WriteMode, SAI1ACLRFRBase> ;
    using CNRDY = SAI1_ACLRFR_CNRDY_Values<SAI1::ACLRFR, 4, 1, WriteMode, SAI1ACLRFRBase> ;
    using WCKCFG = SAI1_ACLRFR_WCKCFG_Values<SAI1::ACLRFR, 2, 1, WriteMode, SAI1ACLRFRBase> ;
    using MUTEDET = SAI1_ACLRFR_MUTEDET_Values<SAI1::ACLRFR, 1, 1, WriteMode, SAI1ACLRFRBase> ;
    using OVRUDR = SAI1_ACLRFR_OVRUDR_Values<SAI1::ACLRFR, 0, 1, WriteMode, SAI1ACLRFRBase> ;
    using FieldValues = SAI1_ACLRFR_OVRUDR_Values<SAI1::ACLRFR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ACLRFRPack  = Register<0x4001541C, 32, WriteMode, SAI1ACLRFRBase, T...> ;
  ...
  struct SAI1PDMCRBase {} ;

  struct PDMCR : public RegisterBase<0x40015444, 32, ReadWriteMode>
  {
    using CKEN4 = SAI1_PDMCR_CKEN4_Values<SAI1::PDMCR, 11, 1, ReadWriteMode, SAI1PDMCRBase> ;
    using CKEN3 = SAI1_PDMCR_CKEN3_Values<SAI1::PDMCR, 10, 1, ReadWriteMode, SAI1PDMCRBase> ;
    using CKEN2 = SAI1_PDMCR_CKEN2_Values<SAI1::PDMCR, 9, 1, ReadWriteMode, SAI1PDMCRBase> ;
    using CKEN1 = SAI1_PDMCR_CKEN1_Values<SAI1::PDMCR, 8, 1, ReadWriteMode, SAI1PDMCRBase> ;
    using MICNBR = SAI1_PDMCR_MICNBR_Values<SAI1::PDMCR, 4, 2, ReadWriteMode, SAI1PDMCRBase> ;
    using PDMEN = SAI1_PDMCR_PDMEN_Values<SAI1::PDMCR, 0, 1, ReadWriteMode, SAI1PDMCRBase> ;
    using FieldValues = SAI1_PDMCR_PDMEN_Values<SAI1::PDMCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using PDMCRPack  = Register<0x40015444, 32, ReadWriteMode, SAI1PDMCRBase, T...> ;

  struct SAI1PDMDLYBase {} ;

  struct PDMDLY : public RegisterBase<0x40015448, 32, ReadWriteMode>
  {
    using DLYM4R = SAI1_PDMDLY_DLYM4R_Values<SAI1::PDMDLY, 28, 3, ReadWriteMode, SAI1PDMDLYBase> ;
    using DLYM4L = SAI1_PDMDLY_DLYM4L_Values<SAI1::PDMDLY, 24, 3, ReadWriteMode, SAI1PDMDLYBase> ;
    using DLYM3R = SAI1_PDMDLY_DLYM3R_Values<SAI1::PDMDLY, 20, 3, ReadWriteMode, SAI1PDMDLYBase> ;
    using DLYM3L = SAI1_PDMDLY_DLYM3L_Values<SAI1::PDMDLY, 16, 3, ReadWriteMode, SAI1PDMDLYBase> ;
    using DLYM2R = SAI1_PDMDLY_DLYM2R_Values<SAI1::PDMDLY, 12, 3, ReadWriteMode, SAI1PDMDLYBase> ;
    using DLYM2L = SAI1_PDMDLY_DLYM2L_Values<SAI1::PDMDLY, 8, 3, ReadWriteMode, SAI1PDMDLYBase> ;
    using DLYM1R = SAI1_PDMDLY_DLYM1R_Values<SAI1::PDMDLY, 4, 3, ReadWriteMode, SAI1PDMDLYBase> ;
    using DLYM1L = SAI1_PDMDLY_DLYM1L_Values<SAI1::PDMDLY, 0, 3, ReadWriteMode, SAI1PDMDLYBase> ;
    using FieldValues = SAI1_PDMDLY_DLYM1L_Values<SAI1::PDMDLY, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using PDMDLYPack  = Register<0x40015448, 32, ReadWriteMode, SAI1PDMDLYBase, T...> ;
