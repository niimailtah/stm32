...
*
* Details       : Analog to Digital Converter instance 1. This header file is
...
struct ADC
{
  ...
  {
    using JQDIS = ADC_CFGR_JQDIS_Values<ADC::CFGR, 31, 1, ReadWriteMode, ADCCFGRBase> ;
  ...
  struct SMPR1 : public RegisterBase<0x50040014, 32, ReadWriteMode>
  {
    ...
    using SMP0 = ADC_SMPR1_SMP0_Values<ADC::SMPR1, 0, 3, ReadWriteMode, ADCSMPR1Base> ;
    using FieldValues = ADC_SMPR1_SMP0_Values<ADC::SMPR1, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct DR : public RegisterBase<0x50040040, 32, ReadWriteMode>
  {
    using RDATA_0_6 = ADC_DR_RDATA_0_6_Values<ADC::DR, 0, 6, ReadWriteMode, ADCDRBase> ;
    using RDATA_7_15 = ADC_DR_RDATA_7_15_Values<ADC::DR, 7, 9, ReadMode, ADCDRBase> ;
    using FieldValues = ADC_DR_RDATA_7_15_Values<ADC::DR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DRPack  = Register<0x50040040, 32, ReadWriteMode, ADCDRBase, T...> ;
  ...
  {
    using AWD2CH = ADC_AWD2CR_AWD2CH_Values<ADC::AWD2CR, 0, 19, ReadWriteMode, ADCAWD2CRBase> ;
  ...
  {
    using AWD3CH = ADC_AWD3CR_AWD3CH_Values<ADC::AWD3CR, 0, 19, ReadWriteMode, ADCAWD3CRBase> ;
  ...
  {
    using DIFSEL_0 = ADC_DIFSEL_DIFSEL_0_Values<ADC::DIFSEL, 0, 1, ReadMode, ADCDIFSELBase> ;
  ...
  struct CCR : public RegisterBase<0x50040308, 32, ReadWriteMode>
  {
    ...
    using PRESC = ADC_CCR_PRESC_Values<ADC::CCR, 18, 4, ReadWriteMode, ADCCCRBase> ;
    using CKMODE = ADC_CCR_CKMODE_Values<ADC::CCR, 16, 2, ReadWriteMode, ADCCCRBase> ;
    using FieldValues = ADC_CCR_CKMODE_Values<ADC::CCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CCRPack  = Register<0x50040308, 32, ReadWriteMode, ADCCCRBase, T...> ;
