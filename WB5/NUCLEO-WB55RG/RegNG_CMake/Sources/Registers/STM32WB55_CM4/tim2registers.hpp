...
struct TIM2
{
  ...
  {
    using UIFREMAP = TIM2_CR1_UIFREMAP_Values<TIM2::CR1, 11, 1, ReadWriteMode, TIM2CR1Base> ;
  ...
  {
    using SMS_3 = TIM2_SMCR_SMS_3_Values<TIM2::SMCR, 16, 1, ReadWriteMode, TIM2SMCRBase> ;
    ...
    using OCCS = TIM2_SMCR_OCCS_Values<TIM2::SMCR, 3, 1, ReadWriteMode, TIM2SMCRBase> ;
  ...
  {
    using OC2M_3 = TIM2_CCMR1_Output_OC2M_3_Values<TIM2::CCMR1_Output, 24, 1, ReadWriteMode, TIM2CCMR1_OutputBase> ;
    using OC1M_3 = TIM2_CCMR1_Output_OC1M_3_Values<TIM2::CCMR1_Output, 16, 1, ReadWriteMode, TIM2CCMR1_OutputBase> ;
  ...
  struct CCMR1_Input : public RegisterBase<0x40000018, 32, ReadWriteMode>
  {
    ...
    using IC2PSC = TIM2_CCMR1_Input_IC2PSC_Values<TIM2::CCMR1_Input, 10, 2, ReadWriteMode, TIM2CCMR1_InputBase> ;
    ...
    using IC1PSC = TIM2_CCMR1_Input_IC1PSC_Values<TIM2::CCMR1_Input, 2, 2, ReadWriteMode, TIM2CCMR1_InputBase> ;
  ...
  {
    using OC4M_3 = TIM2_CCMR2_Output_OC4M_3_Values<TIM2::CCMR2_Output, 24, 1, ReadWriteMode, TIM2CCMR2_OutputBase> ;
    using OC3M_3 = TIM2_CCMR2_Output_OC3M_3_Values<TIM2::CCMR2_Output, 16, 1, ReadWriteMode, TIM2CCMR2_OutputBase> ;
    using OC4CE = TIM2_CCMR2_Output_OC4CE_Values<TIM2::CCMR2_Output, 15, 1, ReadWriteMode, TIM2CCMR2_OutputBase> ;
  ...
  {
    using CNT_H = TIM2_CNT_CNT_H_Values<TIM2::CNT, 16, 15, ReadWriteMode, TIM2CNTBase> ;
    using CNT_L = TIM2_CNT_CNT_L_Values<TIM2::CNT, 0, 16, ReadWriteMode, TIM2CNTBase> ;
    using UIFCPY = TIM2_CNT_UIFCPY_Values<TIM2::CNT, 31, 1, ReadMode, TIM2CNTBase> ;
    using FieldValues = TIM2_CNT_UIFCPY_Values<TIM2::CNT, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TI4_RMP = TIM2_OR_TI4_RMP_Values<TIM2::OR, 2, 2, ReadWriteMode, TIM2ORBase> ;
    using ETR_RMP = TIM2_OR_ETR_RMP_Values<TIM2::OR, 1, 1, ReadWriteMode, TIM2ORBase> ;
    using ITR_RMP = TIM2_OR_ITR_RMP_Values<TIM2::OR, 0, 1, ReadWriteMode, TIM2ORBase> ;
    using FieldValues = TIM2_OR_ITR_RMP_Values<TIM2::OR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct AF : public RegisterBase<0x40000060, 32, ReadWriteMode>
  {
    using ETRSEL = TIM2_AF_ETRSEL_Values<TIM2::AF, 14, 3, ReadWriteMode, TIM2AFBase> ;
    using FieldValues = TIM2_AF_ETRSEL_Values<TIM2::AF, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AFPack  = Register<0x40000060, 32, ReadWriteMode, TIM2AFBase, T...> ;
