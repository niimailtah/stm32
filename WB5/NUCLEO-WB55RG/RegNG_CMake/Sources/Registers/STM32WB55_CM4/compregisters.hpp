...
*
* Details       : Comparator instance 1. This header file is auto-generated for
...
struct COMP
{
  ...
  struct COMP1_CSR : public RegisterBase<0x40010200, 32, ReadWriteMode>
  {
    ...
    using COMP1_LOCK = COMP_COMP1_CSR_COMP1_LOCK_Values<COMP::COMP1_CSR, 31, 1, ReadWriteMode, COMPCOMP1_CSRBase> ;
  ...
  struct COMP2_CSR : public RegisterBase<0x40010204, 32, ReadWriteMode>
  {
    ...
    using COMP2_INMSEL = COMP_COMP2_CSR_COMP2_INMSEL_Values<COMP::COMP2_CSR, 4, 2, ReadWriteMode, COMPCOMP2_CSRBase> ;
    ...
    using COMP2_LOCK = COMP_COMP2_CSR_COMP2_LOCK_Values<COMP::COMP2_CSR, 31, 1, ReadWriteMode, COMPCOMP2_CSRBase> ;
