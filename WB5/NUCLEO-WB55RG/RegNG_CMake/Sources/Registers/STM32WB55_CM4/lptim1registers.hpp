...
struct LPTIM1
{
  ...
  {
    using RSTARE = LPTIM1_CR_RSTARE_Values<LPTIM1::CR, 4, 1, ReadWriteMode, LPTIM1CRBase> ;
    using COUNTRST = LPTIM1_CR_COUNTRST_Values<LPTIM1::CR, 3, 1, ReadWriteMode, LPTIM1CRBase> ;
  ...
  struct OR : public RegisterBase<0x40007C20, 32, ReadWriteMode>
  {
    using OR1 = LPTIM1_OR_OR1_Values<LPTIM1::OR, 0, 1, ReadWriteMode, LPTIM1ORBase> ;
    using OR2 = LPTIM1_OR_OR2_Values<LPTIM1::OR, 1, 1, ReadWriteMode, LPTIM1ORBase> ;
    using FieldValues = LPTIM1_OR_OR2_Values<LPTIM1::OR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ORPack  = Register<0x40007C20, 32, ReadWriteMode, LPTIM1ORBase, T...> ;
