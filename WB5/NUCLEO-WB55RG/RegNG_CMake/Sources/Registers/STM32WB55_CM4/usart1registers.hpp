...
struct USART1
{
  ...
  {
    using RXFFIE = USART1_CR1_RXFFIE_Values<USART1::CR1, 31, 1, ReadWriteMode, USART1CR1Base> ;
    using TXFEIE = USART1_CR1_TXFEIE_Values<USART1::CR1, 30, 1, ReadWriteMode, USART1CR1Base> ;
    using FIFOEN = USART1_CR1_FIFOEN_Values<USART1::CR1, 29, 1, ReadWriteMode, USART1CR1Base> ;
    ...
    using DEAT4 = USART1_CR1_DEAT4_Values<USART1::CR1, 25, 1, ReadWriteMode, USART1CR1Base> ;
    using DEAT3 = USART1_CR1_DEAT3_Values<USART1::CR1, 24, 1, ReadWriteMode, USART1CR1Base> ;
    using DEAT2 = USART1_CR1_DEAT2_Values<USART1::CR1, 23, 1, ReadWriteMode, USART1CR1Base> ;
    using DEAT1 = USART1_CR1_DEAT1_Values<USART1::CR1, 22, 1, ReadWriteMode, USART1CR1Base> ;
    using DEAT0 = USART1_CR1_DEAT0_Values<USART1::CR1, 21, 1, ReadWriteMode, USART1CR1Base> ;
    using DEDT4 = USART1_CR1_DEDT4_Values<USART1::CR1, 20, 1, ReadWriteMode, USART1CR1Base> ;
    using DEDT3 = USART1_CR1_DEDT3_Values<USART1::CR1, 19, 1, ReadWriteMode, USART1CR1Base> ;
    using DEDT2 = USART1_CR1_DEDT2_Values<USART1::CR1, 18, 1, ReadWriteMode, USART1CR1Base> ;
    using DEDT1 = USART1_CR1_DEDT1_Values<USART1::CR1, 17, 1, ReadWriteMode, USART1CR1Base> ;
    using DEDT0 = USART1_CR1_DEDT0_Values<USART1::CR1, 16, 1, ReadWriteMode, USART1CR1Base> ;
    ...
    using M0 = USART1_CR1_M0_Values<USART1::CR1, 12, 1, ReadWriteMode, USART1CR1Base> ;
    ...
    using FieldValues = USART1_CR1_UE_Values<USART1::CR1, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using ADD4_7 = USART1_CR2_ADD4_7_Values<USART1::CR2, 28, 4, ReadWriteMode, USART1CR2Base> ;
    using ADD0_3 = USART1_CR2_ADD0_3_Values<USART1::CR2, 24, 4, ReadWriteMode, USART1CR2Base> ;
    using RTOEN = USART1_CR2_RTOEN_Values<USART1::CR2, 23, 1, ReadWriteMode, USART1CR2Base> ;
    using ABRMOD1 = USART1_CR2_ABRMOD1_Values<USART1::CR2, 22, 1, ReadWriteMode, USART1CR2Base> ;
    using ABRMOD0 = USART1_CR2_ABRMOD0_Values<USART1::CR2, 21, 1, ReadWriteMode, USART1CR2Base> ;
    ...
    using TAINV = USART1_CR2_TAINV_Values<USART1::CR2, 18, 1, ReadWriteMode, USART1CR2Base> ;
    ...
    using DIS_NSS = USART1_CR2_DIS_NSS_Values<USART1::CR2, 3, 1, ReadWriteMode, USART1CR2Base> ;
    using SLVEN = USART1_CR2_SLVEN_Values<USART1::CR2, 0, 1, ReadWriteMode, USART1CR2Base> ;
    using FieldValues = USART1_CR2_SLVEN_Values<USART1::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TXFTCFG = USART1_CR3_TXFTCFG_Values<USART1::CR3, 29, 3, ReadWriteMode, USART1CR3Base> ;
    using RXFTIE = USART1_CR3_RXFTIE_Values<USART1::CR3, 28, 1, ReadWriteMode, USART1CR3Base> ;
    using RXFTCFG = USART1_CR3_RXFTCFG_Values<USART1::CR3, 25, 3, ReadWriteMode, USART1CR3Base> ;
    using TCBGTIE = USART1_CR3_TCBGTIE_Values<USART1::CR3, 24, 1, ReadWriteMode, USART1CR3Base> ;
    using TXFTIE = USART1_CR3_TXFTIE_Values<USART1::CR3, 23, 1, ReadWriteMode, USART1CR3Base> ;
  ...
  {
    using BRRField = USART1_BRR_BRR_Values<USART1::BRR, 0, 16, ReadWriteMode, USART1BRRBase> ;
    using FieldValues = USART1_BRR_BRR_Values<USART1::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct RQR : public RegisterBase<0x40013818, 32, WriteMode>
  {
    using TXFRQ = USART1_RQR_TXFRQ_Values<USART1::RQR, 4, 1, WriteMode, USART1RQRBase> ;
    using RXFRQ = USART1_RQR_RXFRQ_Values<USART1::RQR, 3, 1, WriteMode, USART1RQRBase> ;
    using MMRQ = USART1_RQR_MMRQ_Values<USART1::RQR, 2, 1, WriteMode, USART1RQRBase> ;
    using SBKRQ = USART1_RQR_SBKRQ_Values<USART1::RQR, 1, 1, WriteMode, USART1RQRBase> ;
    using ABRRQ = USART1_RQR_ABRRQ_Values<USART1::RQR, 0, 1, WriteMode, USART1RQRBase> ;
    using FieldValues = USART1_RQR_ABRRQ_Values<USART1::RQR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RQRPack  = Register<0x40013818, 32, WriteMode, USART1RQRBase, T...> ;

  struct USART1ISRBase {} ;

  struct ISR : public RegisterBase<0x4001381C, 32, ReadMode>
  {
    using TXFT = USART1_ISR_TXFT_Values<USART1::ISR, 27, 1, ReadMode, USART1ISRBase> ;
    using RXFT = USART1_ISR_RXFT_Values<USART1::ISR, 26, 1, ReadMode, USART1ISRBase> ;
    using TCBGT = USART1_ISR_TCBGT_Values<USART1::ISR, 25, 1, ReadMode, USART1ISRBase> ;
    using RXFF = USART1_ISR_RXFF_Values<USART1::ISR, 24, 1, ReadMode, USART1ISRBase> ;
    using TXFE = USART1_ISR_TXFE_Values<USART1::ISR, 23, 1, ReadMode, USART1ISRBase> ;
    ...
    using UDR = USART1_ISR_UDR_Values<USART1::ISR, 13, 1, ReadMode, USART1ISRBase> ;
  ...
  struct ICR : public RegisterBase<0x40013820, 32, WriteMode>
  {
    using WUCF = USART1_ICR_WUCF_Values<USART1::ICR, 20, 1, WriteMode, USART1ICRBase> ;
    using CMCF = USART1_ICR_CMCF_Values<USART1::ICR, 17, 1, WriteMode, USART1ICRBase> ;
    using UDRCF = USART1_ICR_UDRCF_Values<USART1::ICR, 13, 1, WriteMode, USART1ICRBase> ;
    using EOBCF = USART1_ICR_EOBCF_Values<USART1::ICR, 12, 1, WriteMode, USART1ICRBase> ;
    using RTOCF = USART1_ICR_RTOCF_Values<USART1::ICR, 11, 1, WriteMode, USART1ICRBase> ;
    using CTSCF = USART1_ICR_CTSCF_Values<USART1::ICR, 9, 1, WriteMode, USART1ICRBase> ;
    using LBDCF = USART1_ICR_LBDCF_Values<USART1::ICR, 8, 1, WriteMode, USART1ICRBase> ;
    using TCBGTCF = USART1_ICR_TCBGTCF_Values<USART1::ICR, 7, 1, WriteMode, USART1ICRBase> ;
    using TCCF = USART1_ICR_TCCF_Values<USART1::ICR, 6, 1, WriteMode, USART1ICRBase> ;
    using TXFECF = USART1_ICR_TXFECF_Values<USART1::ICR, 5, 1, WriteMode, USART1ICRBase> ;
    using IDLECF = USART1_ICR_IDLECF_Values<USART1::ICR, 4, 1, WriteMode, USART1ICRBase> ;
    using ORECF = USART1_ICR_ORECF_Values<USART1::ICR, 3, 1, WriteMode, USART1ICRBase> ;
    using NCF = USART1_ICR_NCF_Values<USART1::ICR, 2, 1, WriteMode, USART1ICRBase> ;
    using FECF = USART1_ICR_FECF_Values<USART1::ICR, 1, 1, WriteMode, USART1ICRBase> ;
    using PECF = USART1_ICR_PECF_Values<USART1::ICR, 0, 1, WriteMode, USART1ICRBase> ;
    using FieldValues = USART1_ICR_PECF_Values<USART1::ICR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ICRPack  = Register<0x40013820, 32, WriteMode, USART1ICRBase, T...> ;
  ...
  struct USART1PRESCBase {} ;

  struct PRESC : public RegisterBase<0x4001382C, 32, ReadWriteMode>
  {
    using PRESCALER = USART1_PRESC_PRESCALER_Values<USART1::PRESC, 0, 4, ReadWriteMode, USART1PRESCBase> ;
    using FieldValues = USART1_PRESC_PRESCALER_Values<USART1::PRESC, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using PRESCPack  = Register<0x4001382C, 32, ReadWriteMode, USART1PRESCBase, T...> ;
