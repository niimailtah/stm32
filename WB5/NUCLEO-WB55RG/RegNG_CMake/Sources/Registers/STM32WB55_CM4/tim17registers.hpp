...
struct TIM17
{
  ...
  struct DIER : public RegisterBase<0x4001480C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM17_DIER_CC1DE_Values<TIM17::DIER, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CCMR1_Output : public RegisterBase<0x40014818, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM17_CCMR1_Output_CC1S_Values<TIM17::CCMR1_Output, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct BDTR : public RegisterBase<0x40014844, 32, ReadWriteMode>
  {
    ...
    using BKDSRM = TIM17_BDTR_BKDSRM_Values<TIM17::BDTR, 26, 1, ReadWriteMode, TIM17BDTRBase> ;
    using BKBID = TIM17_BDTR_BKBID_Values<TIM17::BDTR, 28, 1, ReadWriteMode, TIM17BDTRBase> ;
    using FieldValues = TIM17_BDTR_BKBID_Values<TIM17::BDTR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct OR1 : public RegisterBase<0x40014850, 32, ReadWriteMode>
  {
    using TI1_RMP = TIM17_OR1_TI1_RMP_Values<TIM17::OR1, 0, 2, ReadWriteMode, TIM17OR1Base> ;
    using FieldValues = TIM17_OR1_TI1_RMP_Values<TIM17::OR1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using OR1Pack  = Register<0x40014850, 32, ReadWriteMode, TIM17OR1Base, T...> ;

  struct TIM17AF1Base {} ;

  struct AF1 : public RegisterBase<0x40014860, 32, ReadWriteMode>
  {
    using BKINE = TIM17_AF1_BKINE_Values<TIM17::AF1, 0, 1, ReadWriteMode, TIM17AF1Base> ;
    using BKCMP1E = TIM17_AF1_BKCMP1E_Values<TIM17::AF1, 1, 1, ReadWriteMode, TIM17AF1Base> ;
    using BKCMP2E = TIM17_AF1_BKCMP2E_Values<TIM17::AF1, 2, 1, ReadWriteMode, TIM17AF1Base> ;
    using BKINP = TIM17_AF1_BKINP_Values<TIM17::AF1, 9, 1, ReadWriteMode, TIM17AF1Base> ;
    using BKCMP1P = TIM17_AF1_BKCMP1P_Values<TIM17::AF1, 10, 1, ReadWriteMode, TIM17AF1Base> ;
    using BKCMP2P = TIM17_AF1_BKCMP2P_Values<TIM17::AF1, 11, 1, ReadWriteMode, TIM17AF1Base> ;
    using FieldValues = TIM17_AF1_BKCMP2P_Values<TIM17::AF1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AF1Pack  = Register<0x40014860, 32, ReadWriteMode, TIM17AF1Base, T...> ;

  struct TIM17TISELBase {} ;

  struct TISEL : public RegisterBase<0x40014868, 32, ReadWriteMode>
  {
    using TI1SEL = TIM17_TISEL_TI1SEL_Values<TIM17::TISEL, 0, 4, ReadWriteMode, TIM17TISELBase> ;
    using FieldValues = TIM17_TISEL_TI1SEL_Values<TIM17::TISEL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using TISELPack  = Register<0x40014868, 32, ReadWriteMode, TIM17TISELBase, T...> ;
