...
struct TIM16
{
  ...
  struct DIER : public RegisterBase<0x4001440C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM16_DIER_CC1DE_Values<TIM16::DIER, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CCMR1_Output : public RegisterBase<0x40014418, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM16_CCMR1_Output_CC1S_Values<TIM16::CCMR1_Output, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct BDTR : public RegisterBase<0x40014444, 32, ReadWriteMode>
  {
    ...
    using BKDSRM = TIM16_BDTR_BKDSRM_Values<TIM16::BDTR, 26, 1, ReadWriteMode, TIM16BDTRBase> ;
    using BKBID = TIM16_BDTR_BKBID_Values<TIM16::BDTR, 28, 1, ReadWriteMode, TIM16BDTRBase> ;
    using FieldValues = TIM16_BDTR_BKBID_Values<TIM16::BDTR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct OR1 : public RegisterBase<0x40014450, 32, ReadWriteMode>
  {
    using TI1_RMP = TIM16_OR1_TI1_RMP_Values<TIM16::OR1, 0, 2, ReadWriteMode, TIM16OR1Base> ;
    using FieldValues = TIM16_OR1_TI1_RMP_Values<TIM16::OR1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using OR1Pack  = Register<0x40014450, 32, ReadWriteMode, TIM16OR1Base, T...> ;

  struct TIM16AF1Base {} ;

  struct AF1 : public RegisterBase<0x40014460, 32, ReadWriteMode>
  {
    using BKINE = TIM16_AF1_BKINE_Values<TIM16::AF1, 0, 1, ReadWriteMode, TIM16AF1Base> ;
    using BKCMP1E = TIM16_AF1_BKCMP1E_Values<TIM16::AF1, 1, 1, ReadWriteMode, TIM16AF1Base> ;
    using BKCMP2E = TIM16_AF1_BKCMP2E_Values<TIM16::AF1, 2, 1, ReadWriteMode, TIM16AF1Base> ;
    using BKINP = TIM16_AF1_BKINP_Values<TIM16::AF1, 9, 1, ReadWriteMode, TIM16AF1Base> ;
    using BKCMP1P = TIM16_AF1_BKCMP1P_Values<TIM16::AF1, 10, 1, ReadWriteMode, TIM16AF1Base> ;
    using BKCMP2P = TIM16_AF1_BKCMP2P_Values<TIM16::AF1, 11, 1, ReadWriteMode, TIM16AF1Base> ;
    using FieldValues = TIM16_AF1_BKCMP2P_Values<TIM16::AF1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AF1Pack  = Register<0x40014460, 32, ReadWriteMode, TIM16AF1Base, T...> ;

  struct TIM16TISELBase {} ;

  struct TISEL : public RegisterBase<0x40014468, 32, ReadWriteMode>
  {
    using TI1SEL = TIM16_TISEL_TI1SEL_Values<TIM16::TISEL, 0, 4, ReadWriteMode, TIM16TISELBase> ;
    using FieldValues = TIM16_TISEL_TI1SEL_Values<TIM16::TISEL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using TISELPack  = Register<0x40014468, 32, ReadWriteMode, TIM16TISELBase, T...> ;
