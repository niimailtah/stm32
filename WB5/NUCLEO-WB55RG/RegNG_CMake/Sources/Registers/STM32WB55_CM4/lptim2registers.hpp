...
struct LPTIM2
{
  ...
  {
    using RSTARE = LPTIM2_CR_RSTARE_Values<LPTIM2::CR, 4, 1, ReadWriteMode, LPTIM2CRBase> ;
    using COUNTRST = LPTIM2_CR_COUNTRST_Values<LPTIM2::CR, 3, 1, ReadWriteMode, LPTIM2CRBase> ;
  ...
  struct OR : public RegisterBase<0x40009420, 32, ReadWriteMode>
  {
    using OR1 = LPTIM2_OR_OR1_Values<LPTIM2::OR, 0, 1, ReadWriteMode, LPTIM2ORBase> ;
    using OR2 = LPTIM2_OR_OR2_Values<LPTIM2::OR, 1, 1, ReadWriteMode, LPTIM2ORBase> ;
    using FieldValues = LPTIM2_OR_OR2_Values<LPTIM2::OR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ORPack  = Register<0x40009420, 32, ReadWriteMode, LPTIM2ORBase, T...> ;
