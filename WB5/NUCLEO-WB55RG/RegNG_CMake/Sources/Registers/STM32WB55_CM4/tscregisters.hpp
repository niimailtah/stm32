...
struct TSC
{
  ...
  {
    using G7_IO4 = TSC_IOHCR_G7_IO4_Values<TSC::IOHCR, 27, 1, ReadWriteMode, TSCIOHCRBase> ;
    using G7_IO3 = TSC_IOHCR_G7_IO3_Values<TSC::IOHCR, 26, 1, ReadWriteMode, TSCIOHCRBase> ;
    using G7_IO2 = TSC_IOHCR_G7_IO2_Values<TSC::IOHCR, 25, 1, ReadWriteMode, TSCIOHCRBase> ;
    using G7_IO1 = TSC_IOHCR_G7_IO1_Values<TSC::IOHCR, 24, 1, ReadWriteMode, TSCIOHCRBase> ;
  ...
  {
    using G7_IO4 = TSC_IOASCR_G7_IO4_Values<TSC::IOASCR, 27, 1, ReadWriteMode, TSCIOASCRBase> ;
    using G7_IO3 = TSC_IOASCR_G7_IO3_Values<TSC::IOASCR, 26, 1, ReadWriteMode, TSCIOASCRBase> ;
    using G7_IO2 = TSC_IOASCR_G7_IO2_Values<TSC::IOASCR, 25, 1, ReadWriteMode, TSCIOASCRBase> ;
    using G7_IO1 = TSC_IOASCR_G7_IO1_Values<TSC::IOASCR, 24, 1, ReadWriteMode, TSCIOASCRBase> ;
  ...
  {
    using G7_IO4 = TSC_IOSCR_G7_IO4_Values<TSC::IOSCR, 27, 1, ReadWriteMode, TSCIOSCRBase> ;
    using G7_IO3 = TSC_IOSCR_G7_IO3_Values<TSC::IOSCR, 26, 1, ReadWriteMode, TSCIOSCRBase> ;
    using G7_IO2 = TSC_IOSCR_G7_IO2_Values<TSC::IOSCR, 25, 1, ReadWriteMode, TSCIOSCRBase> ;
    using G7_IO1 = TSC_IOSCR_G7_IO1_Values<TSC::IOSCR, 24, 1, ReadWriteMode, TSCIOSCRBase> ;
  ...
  {
    using G7_IO4 = TSC_IOCCR_G7_IO4_Values<TSC::IOCCR, 27, 1, ReadWriteMode, TSCIOCCRBase> ;
    using G7_IO3 = TSC_IOCCR_G7_IO3_Values<TSC::IOCCR, 26, 1, ReadWriteMode, TSCIOCCRBase> ;
    using G7_IO2 = TSC_IOCCR_G7_IO2_Values<TSC::IOCCR, 25, 1, ReadWriteMode, TSCIOCCRBase> ;
    using G7_IO1 = TSC_IOCCR_G7_IO1_Values<TSC::IOCCR, 24, 1, ReadWriteMode, TSCIOCCRBase> ;
  ...
  {
    using G7S = TSC_IOGCSR_G7S_Values<TSC::IOGCSR, 22, 1, ReadMode, TSCIOGCSRBase> ;
  ...
  struct TSCIOG7CRBase {} ;

  struct IOG7CR : public RegisterBase<0x4002404C, 32, ReadMode>
  {
    using CNT = TSC_IOG7CR_CNT_Values<TSC::IOG7CR, 0, 14, ReadMode, TSCIOG7CRBase> ;
    using FieldValues = TSC_IOG7CR_CNT_Values<TSC::IOG7CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using IOG7CRPack  = Register<0x4002404C, 32, ReadMode, TSCIOG7CRBase, T...> ;
