...
struct GPIOA
{
  ...
  struct MODER : public RegisterBase<0x48000000, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using MODERPack  = Register<0x48000000, 32, ReadWriteMode, GPIOAMODERBase, T...> ;

  struct GPIOAOTYPERBase {} ;

  struct OTYPER : public RegisterBase<0x48000004, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OTYPERPack  = Register<0x48000004, 32, ReadWriteMode, GPIOAOTYPERBase, T...> ;

  struct GPIOAOSPEEDRBase {} ;

  struct OSPEEDR : public RegisterBase<0x48000008, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OSPEEDRPack  = Register<0x48000008, 32, ReadWriteMode, GPIOAOSPEEDRBase, T...> ;

  struct GPIOAPUPDRBase {} ;

  struct PUPDR : public RegisterBase<0x4800000C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PUPDRPack  = Register<0x4800000C, 32, ReadWriteMode, GPIOAPUPDRBase, T...> ;

  struct GPIOAIDRBase {} ;

  struct IDR : public RegisterBase<0x48000010, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using IDRPack  = Register<0x48000010, 32, ReadMode, GPIOAIDRBase, T...> ;

  struct GPIOAODRBase {} ;

  struct ODR : public RegisterBase<0x48000014, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ODRPack  = Register<0x48000014, 32, ReadWriteMode, GPIOAODRBase, T...> ;

  struct GPIOABSRRBase {} ;

  struct BSRR : public RegisterBase<0x48000018, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using BSRRPack  = Register<0x48000018, 32, WriteMode, GPIOABSRRBase, T...> ;

  struct GPIOALCKRBase {} ;

  struct LCKR : public RegisterBase<0x4800001C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LCKRPack  = Register<0x4800001C, 32, ReadWriteMode, GPIOALCKRBase, T...> ;

  struct GPIOAAFRLBase {} ;

  struct AFRL : public RegisterBase<0x48000020, 32, ReadWriteMode>
  {
    ...
    using FieldValues = GPIOA_AFRL_AFSEL0_Values<GPIOA::AFRL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AFRLPack  = Register<0x48000020, 32, ReadWriteMode, GPIOAAFRLBase, T...> ;

  struct GPIOAAFRHBase {} ;

  struct AFRH : public RegisterBase<0x48000024, 32, ReadWriteMode>
  {
    ...
    using FieldValues = GPIOA_AFRH_AFSEL8_Values<GPIOA::AFRH, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AFRHPack  = Register<0x48000024, 32, ReadWriteMode, GPIOAAFRHBase, T...> ;

  struct GPIOABRRBase {} ;

  struct BRR : public RegisterBase<0x48000028, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using BRRPack  = Register<0x48000028, 32, WriteMode, GPIOABRRBase, T...> ;
