...
struct I2C3
{
  ...
  struct CR2 : public RegisterBase<0x40005C04, 32, ReadWriteMode>
  {
    ...
    using SADD = I2C3_CR2_SADD_Values<I2C3::CR2, 0, 10, ReadWriteMode, I2C3CR2Base> ;
    using FieldValues = I2C3_CR2_SADD_Values<I2C3::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using OA1 = I2C3_OAR1_OA1_Values<I2C3::OAR1, 0, 10, ReadWriteMode, I2C3OAR1Base> ;
  ...
  struct TIMINGR : public RegisterBase<0x40005C10, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TIMINGRPack  = Register<0x40005C10, 32, ReadWriteMode, I2C3TIMINGRBase, T...> ;

  struct I2C3TIMEOUTRBase {} ;

  struct TIMEOUTR : public RegisterBase<0x40005C14, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TIMEOUTRPack  = Register<0x40005C14, 32, ReadWriteMode, I2C3TIMEOUTRBase, T...> ;

  struct I2C3ISRBase {} ;

  struct ISR : public RegisterBase<0x40005C18, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ISRPack  = Register<0x40005C18, 32, ReadWriteMode, I2C3ISRBase, T...> ;

  struct I2C3ICRBase {} ;

  struct ICR : public RegisterBase<0x40005C1C, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using ICRPack  = Register<0x40005C1C, 32, WriteMode, I2C3ICRBase, T...> ;

  struct I2C3PECRBase {} ;

  struct PECR : public RegisterBase<0x40005C20, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using PECRPack  = Register<0x40005C20, 32, ReadMode, I2C3PECRBase, T...> ;

  struct I2C3RXDRBase {} ;

  struct RXDR : public RegisterBase<0x40005C24, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RXDRPack  = Register<0x40005C24, 32, ReadMode, I2C3RXDRBase, T...> ;

  struct I2C3TXDRBase {} ;

  struct TXDR : public RegisterBase<0x40005C28, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TXDRPack  = Register<0x40005C28, 32, ReadWriteMode, I2C3TXDRBase, T...> ;
