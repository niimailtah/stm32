...
struct GPIOB
{
  ...
  struct MODER : public RegisterBase<0x48000400, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using MODERPack  = Register<0x48000400, 32, ReadWriteMode, GPIOBMODERBase, T...> ;

  struct GPIOBOTYPERBase {} ;

  struct OTYPER : public RegisterBase<0x48000404, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OTYPERPack  = Register<0x48000404, 32, ReadWriteMode, GPIOBOTYPERBase, T...> ;

  struct GPIOBOSPEEDRBase {} ;

  struct OSPEEDR : public RegisterBase<0x48000408, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OSPEEDRPack  = Register<0x48000408, 32, ReadWriteMode, GPIOBOSPEEDRBase, T...> ;

  struct GPIOBPUPDRBase {} ;

  struct PUPDR : public RegisterBase<0x4800040C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PUPDRPack  = Register<0x4800040C, 32, ReadWriteMode, GPIOBPUPDRBase, T...> ;

  struct GPIOBIDRBase {} ;

  struct IDR : public RegisterBase<0x48000410, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using IDRPack  = Register<0x48000410, 32, ReadMode, GPIOBIDRBase, T...> ;

  struct GPIOBODRBase {} ;

  struct ODR : public RegisterBase<0x48000414, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ODRPack  = Register<0x48000414, 32, ReadWriteMode, GPIOBODRBase, T...> ;

  struct GPIOBBSRRBase {} ;

  struct BSRR : public RegisterBase<0x48000418, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using BSRRPack  = Register<0x48000418, 32, WriteMode, GPIOBBSRRBase, T...> ;

  struct GPIOBLCKRBase {} ;

  struct LCKR : public RegisterBase<0x4800041C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LCKRPack  = Register<0x4800041C, 32, ReadWriteMode, GPIOBLCKRBase, T...> ;

  struct GPIOBAFRLBase {} ;

  struct AFRL : public RegisterBase<0x48000420, 32, ReadWriteMode>
  {
    ...
    using FieldValues = GPIOB_AFRL_AFSEL0_Values<GPIOB::AFRL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AFRLPack  = Register<0x48000420, 32, ReadWriteMode, GPIOBAFRLBase, T...> ;

  struct GPIOBAFRHBase {} ;

  struct AFRH : public RegisterBase<0x48000424, 32, ReadWriteMode>
  {
    ...
    using FieldValues = GPIOB_AFRH_AFSEL8_Values<GPIOB::AFRH, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AFRHPack  = Register<0x48000424, 32, ReadWriteMode, GPIOBAFRHBase, T...> ;

  struct GPIOBBRRBase {} ;

  struct BRR : public RegisterBase<0x48000428, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using BRRPack  = Register<0x48000428, 32, WriteMode, GPIOBBRRBase, T...> ;
