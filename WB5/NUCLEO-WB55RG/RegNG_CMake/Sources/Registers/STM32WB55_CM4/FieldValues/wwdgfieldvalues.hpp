...
struct WWDG_CFR_WDGTB_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  ...
  using Value4 = FieldValue<WWDG_CFR_WDGTB_Values, BaseType, 4U> ;
  using Value5 = FieldValue<WWDG_CFR_WDGTB_Values, BaseType, 5U> ;
  using Value6 = FieldValue<WWDG_CFR_WDGTB_Values, BaseType, 6U> ;
  using Value7 = FieldValue<WWDG_CFR_WDGTB_Values, BaseType, 7U> ;
} ;
