...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct IWDG_SR_WVU_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<IWDG_SR_WVU_Values, BaseType, 0U> ;
  using Value1 = FieldValue<IWDG_SR_WVU_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct IWDG_WINR_WIN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
} ;
