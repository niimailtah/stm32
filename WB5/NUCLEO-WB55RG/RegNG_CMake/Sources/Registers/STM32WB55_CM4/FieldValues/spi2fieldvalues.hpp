...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct SPI2_CR1_CRCL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<SPI2_CR1_CRCL_Values, BaseType, 0U> ;
  using Value1 = FieldValue<SPI2_CR1_CRCL_Values, BaseType, 1U> ;
} ;
