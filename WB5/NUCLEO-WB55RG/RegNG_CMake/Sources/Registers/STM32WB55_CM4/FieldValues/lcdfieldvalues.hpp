...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct LCD_RAM_COM0_S31_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<LCD_RAM_COM0_S31_Values, BaseType, 0U> ;
  using Value1 = FieldValue<LCD_RAM_COM0_S31_Values, BaseType, 1U> ;
} ;
