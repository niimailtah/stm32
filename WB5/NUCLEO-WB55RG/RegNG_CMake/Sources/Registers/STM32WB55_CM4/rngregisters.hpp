...
struct RNG
{
  ...
  struct CR : public RegisterBase<0x58001000, 32, ReadWriteMode>
  {
    ...
    using BYP = RNG_CR_BYP_Values<RNG::CR, 6, 1, ReadWriteMode, RNGCRBase> ;
    using FieldValues = RNG_CR_BYP_Values<RNG::CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CRPack  = Register<0x58001000, 32, ReadWriteMode, RNGCRBase, T...> ;

  struct RNGSRBase {} ;

  struct SR : public RegisterBase<0x58001004, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SRPack  = Register<0x58001004, 32, ReadWriteMode, RNGSRBase, T...> ;

  struct RNGDRBase {} ;

  struct DR : public RegisterBase<0x58001008, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using DRPack  = Register<0x58001008, 32, ReadMode, RNGDRBase, T...> ;
